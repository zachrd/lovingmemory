<template>
        ...
        <li><NuxtLink to="/memorial-arrangements"><span class="icon">
        ...
        <li><NuxtLink to="/charity-donation"><span class="icon">
          ...
          </span><span class="menu"><span>Charitable </span>Donations</span></NuxtLink></li>
      </ul>
